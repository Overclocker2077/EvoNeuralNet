...
public class Brain {
    ...
    */
// random brain;   The num of inputs is not specified because the input layer doesn't actually compute anything the input vector gets passed straight into the hidden layers
    ...
    private double activation_function(double input) {
        ...
        // int num1 = Math.exp(input);
        // int num2 = Math.exp(-input);
        // return (num1 - num2) / (num1 + num2);
        
        //return Math.tanh(input);
        
        // The cube root of x compressed by 1/2 is a sort of similar to the tanh function but should be faster because theirs no exponentials. 
        return 0.5 * Math.cbrt(input);  
